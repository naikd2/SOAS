        ...
        <div class="col-sm-11">
            <ul class="list-group">
                ...
                <div class="tab" style="text-align: center">
                    <g:link action="prevSemester" semesterId="${reportSemester}" class="pull-left">
                        <span class="glyphicon glyphicon-chevron-left" class="btn btn-default" aria-hidden="true"></span>
                    </g:link>
                    ...
                    <g:link action="nextSemester" semesterId="${reportSemester}" class="pull-right">
                        <span class="glyphicon glyphicon-chevron-right" class="btn btn-default" aria-hidden="true"></span>
                    </g:link>
                </div>
                ...
                <g:each in="${myService.findAllReleventOutcomes(courseReportInstance.id)}" var="studentOutcome" >
                    ...
                    <div>
                        <table style="font-size: 16px; text-align: center; width:70%; margin-left:15%; margin-right:15%;" border="1" class="fixed">
                            <tr>
                                <th>Criterion</th><th>Faculty Evaluations</th><th>Student Surveys</th><th>Delta</th>
