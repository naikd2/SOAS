...
class ClassControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        then:"A redirect is issued to the show action"
            response.redirectedUrl == '/class/show/1'
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            ...
            controller.show(class)

        then:"A model is populated containing the domain instance"
            model.classInstance == class
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        then:"A 404 error is returned"
            response.redirectedUrl == '/class/index'
            flash.message != null
        ...
        when:"A valid domain instance is passed to the update action"
            response.reset()
            populateValidParams(params)
            class = new Class(params).save(flush: true)
            controller.update(class)

        then:"A redirect is issues to the show action"
            response.redirectedUrl == "/class/show/$class.id"
            flash.message != null
    }
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            response.reset()
            populateValidParams(params)
            def class = new Class(params).save(flush: true)
