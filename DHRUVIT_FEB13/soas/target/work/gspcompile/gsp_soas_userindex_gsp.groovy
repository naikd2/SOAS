...
class gsp_soas_userindex_gsp extends GroovyPage {
...
printHtmlPart(12)
invokeTag('sortableColumn','g',27,['property':("userId"),'title':(message(code: 'user.userId.label', default: 'User Id'))],-1)
printHtmlPart(13)
invokeTag('sortableColumn','g',29,['property':("password"),'title':(message(code: 'user.password.label', default: 'Password'))],-1)
printHtmlPart(14)
invokeTag('message','g',31,['code':("user.profile.label"),'default':("Profile")],-1)
printHtmlPart(15)
loop:{
int i = 0
...
printHtmlPart(17)
createTagBody(3, {->
expressionOut.print(fieldValue(bean: userInstance, field: "userId"))
})
invokeTag('link','g',39,['action':("show"),'id':(userInstance.id)],3)
printHtmlPart(18)
expressionOut.print(fieldValue(bean: userInstance, field: "password"))
printHtmlPart(18)
expressionOut.print(fieldValue(bean: userInstance, field: "profile"))
printHtmlPart(19)
i++
}
}
...
public static final long LAST_MODIFIED = 1445918607000L
