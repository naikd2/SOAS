...
createTagBody(2, {->
printHtmlPart(7)
invokeTag('hiddenField','g',37,['name':("version"),'value':(studentOutcomeInstance?.version)],-1)
printHtmlPart(8)
...
invokeTag('form','g',43,['url':([resource:studentOutcomeInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(11)
})
...
public static final long LAST_MODIFIED = 1449538410000L
