...
class gsp_soas_usershow_gsp extends GroovyPage {
...
printHtmlPart(13)
if(true && (userInstance?.userId)) {
printHtmlPart(14)
invokeTag('message','g',28,['code':("user.userId.label"),'default':("User Id")],-1)
printHtmlPart(15)
invokeTag('fieldValue','g',30,['bean':(userInstance),'field':("userId")],-1)
printHtmlPart(16)
}
printHtmlPart(17)
...
public static final long LAST_MODIFIED = 1445918599000L
